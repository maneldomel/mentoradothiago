                    ...
                    <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <button className="border border-red-500 px-4 py-2 rounded">
                          <span className="text-red-500 font-bold text-sm uppercase">SUBSCRIBE</span>
                        </button>
                        
                        {/* Sign In Link */}
                        <span className="text-black font-bold text-sm uppercase cursor-pointer hover:text-gray-600">SIGN IN</span>
