  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-magenta-50 to-magenta-100" style={{ minHeight: import.meta.env.PROD ? '100vh' : 'calc(100vh - 60px)' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        {/* Section Toggle */}
        <div className="mb-4">
          <div className="bg-white rounded-lg shadow-md p-1 inline-flex w-full sm:w-auto">
            <button
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-4">
          {activeSection === 'testimonials' ? (
            <>
              <div className="bg-white rounded-lg shadow-md p-3 border-l-4 border-magenta-500">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <div className="w-6 h-6 bg-magenta-100 rounded-md flex items-center justify-center">
                      <MessageSquare className="w-3 h-3 text-magenta-600" />
                    </div>
                  </div>
                  <div className="ml-2">
                    <p className="text-xs font-medium text-gray-500">Total</p>
                    <p className="text-lg font-bold text-gray-900">{testimonials.length}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-3 border-l-4 border-green-500">
                <div className="flex items-center">
                  ...
                  <div className="ml-2">
                    ...
                    <p className="text-lg font-bold text-gray-900">{testimonials.filter(t => t.is_active).length}</p>
                  </div>
                </div>
              </div>
              
              <div className="bg-white rounded-lg shadow-md p-3 border-l-4 border-gray-500">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
            ...
            <>
              ...
              <div className="bg-white rounded-lg shadow-md p-3 border-l-4 border-green-500">
                <div className="flex items-center">
                  ...
                  <div className="ml-2">
                    <p className="text-xs font-medium text-gray-500">Ativos</p>
                    <p className="text-lg font-bold text-gray-900">{doctors.filter(d => d.is_active).length}</p>
                  </div>
                </div>
              </div>
        ...
        <div className="mb-4">
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-magenta-600 to-magenta-700 hover:from-magenta-700 hover:to-magenta-800 text-white text-sm font-bold rounded-lg shadow-lg transition-all duration-200 transform hover:scale-105"
          >
        ...
        {(showAddForm || editingId) && (
          <div className="bg-white rounded-xl shadow-xl mb-6 overflow-hidden">
            <div className="bg-gradient-to-r from-magenta-600 to-magenta-700 px-4 py-3">
            ...
            <div className="p-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <h3 className="text-base font-semibold text-gray-800 flex items-center">
                      <User className="w-4 h-4 mr-2 text-magenta-600" />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-magenta-500 focus:border-transparent transition-all"
                  ...
                  <div className="space-y-3">
                    <h3 className="text-base font-semibold text-gray-800 flex items-center">
                      <Image className="w-4 h-4 mr-2 text-magenta-600" />
                      Mídia e Conteúdo
                    </h3>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-magenta-500 focus:border-transparent transition-all resize-none"
              ...
              <div className="flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-3 mt-6 pt-4 border-t border-gray-200">
                <button
                  onClick={resetForm}
                  className="w-full sm:w-auto px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 text-sm font-medium transition-colors"
                >
                  Cancelar
                </button>
                <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {activeSection === 'testimonials' ? (
            testimonials.map((testimonial) => (
              <div key={testimonial.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300">
                {/* Card Header */}
                <div className="relative">
                  <div className="h-1 bg-gradient-to-r from-magenta-500 to-magenta-600"></div>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-3">
                        <img
                          ...
                          className="w-10 h-10 rounded-full object-cover border-2 border-magenta-200"
                        />
                        <div>
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="text-xs text-gray-500">{testimonial.display_order}</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-1">
                      <button
                        ...
                        className="inline-flex items-center px-2 py-1 text-blue-700 bg-blue-100 hover:bg-blue-200 rounded-md text-xs font-medium transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="inline-flex items-center px-2 py-1 text-red-700 bg-red-100 hover:bg-red-200 rounded-md text-xs font-medium transition-colors"
                      >
                ...
                <div className="relative">
                  ...
                  <div className="p-4 pb-3">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center space-x-1">
                        <Hash className="w-3 h-3 text-gray-400" />
                        <span className="text-xs text-gray-500">{doctor.display_order}</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="text-center py-8 bg-white rounded-xl shadow-md">
                {activeSection === 'testimonials' ? (
                  <>
                    ...
                    <h3 className="text-lg font-semibold text-gray-600 mb-2">Nenhum depoimento encontrado</h3>
                    <p className="text-gray-500 mb-4 text-sm">Adicione seu primeiro depoimento para começar</p>
                  </>
                ) : (
                  <>
                    <Stethoscope className="w-12 h-12 text-gray-300 mx-auto mb-3" />
                    <h3 className="text-lg font-semibold text-gray-600 mb-2">Nenhum médico encontrado</h3>
                    <p className="text-gray-500 mb-4 text-sm">Adicione seu primeiro médico para começar</p>
                  </>
                )}
                <button
                  onClick={() => {
                  ...
                  className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-magenta-600 to-magenta-700 hover:from-magenta-700 hover:to-magenta-800 text-white text-sm font-bold rounded-lg shadow-lg transition-all duration-200 transform hover:scale-105"
                >
                  <Plus className="w-5 h-5 mr-2" />
