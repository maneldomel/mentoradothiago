...
const defaultTestimonials: Testimonial[] = [
  {
    ...
    caption: 'Proaxion completely changed my life. In just 3 months I felt an incredible difference in my energy and stamina.',
    is_active: true,
    display_order: 1,
  ...
  },
  {
    ...
    youtube_url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    caption: 'At 45 I thought it was too late, but Proaxion proved me wrong. I feel like I\'m 25 again!',
    is_active: true,
    display_order: 3,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
